...
post {
    always {
        slackSend(channel: "#fundamentos-de-devops", username: "AlfredoCrDev", token: "tokenslack", message: "La ejecución del Pipeline ${BUILD_NUMBER} ha finalizado con estado ${currentBuild.result}, mas informacion en ${RUN_DISPLAY_URL} ")
    }
}
